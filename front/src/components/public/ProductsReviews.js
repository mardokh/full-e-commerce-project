        ...
        <div>
            {reviewsOnDisplay &&
                <section className="details_comment_and_notes_global_container">
                    <div className="details_comment_and_notes_parent_container">
                        {userConnected ?
                            ...
                            : <div>connect and register element</div>
                        }
                    </div>
                </section>
            }
                            ...
                            <div className="details_reviews_item" key={item.id}>
                                ...
                                {item.user_id == user_id &&
                                    <div className="details_reviews_icons_container">
                                        <svg className="details_reviews_icon" viewBox="0 0 20 20">
